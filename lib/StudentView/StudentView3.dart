...
class studentview3 extends StatefulWidget {
  const studentview3({super.key});

  @override
  State<studentview3> createState() => studentview3State();
}

class studentview3State extends State<studentview3> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user3');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user3');
