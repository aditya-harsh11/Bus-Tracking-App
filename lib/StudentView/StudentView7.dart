...
class studentview7 extends StatefulWidget {
  const studentview7({super.key});

  @override
  State<studentview7> createState() => studentview7State();
}

class studentview7State extends State<studentview7> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user7');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user7');
