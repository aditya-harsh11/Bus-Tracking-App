...
class studentview8 extends StatefulWidget {
  const studentview8({super.key});

  @override
  State<studentview8> createState() => studentview8State();
}

class studentview8State extends State<studentview8> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user8');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user8');
