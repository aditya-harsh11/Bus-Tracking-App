...
class studentview2 extends StatefulWidget {
  const studentview2({super.key});

  @override
  State<studentview2> createState() => studentview2State();
}

class studentview2State extends State<studentview2> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user2');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user2');
