...
class studentview12 extends StatefulWidget {
  const studentview12({super.key});

  @override
  State<studentview12> createState() => studentview12State();
}

class studentview12State extends State<studentview12> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user12');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user12');
