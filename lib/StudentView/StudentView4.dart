...
class studentview4 extends StatefulWidget {
  const studentview4({super.key});

  @override
  State<studentview4> createState() => studentview4State();
}

class studentview4State extends State<studentview4> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user4');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user4');
