...
class studentview11 extends StatefulWidget {
  const studentview11({super.key});

  @override
  State<studentview11> createState() => studentview11State();
}

class studentview11State extends State<studentview11> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user11');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user11');
