...
class studentview14 extends StatefulWidget {
  const studentview14({super.key});

  @override
  State<studentview14> createState() => studentview14State();
}

class studentview14State extends State<studentview14> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user14');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user14');
