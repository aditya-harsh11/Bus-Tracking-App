...
class studentview6 extends StatefulWidget {
  const studentview6({super.key});

  @override
  State<studentview6> createState() => studentview6State();
}

class studentview6State extends State<studentview6> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user6');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user6');
