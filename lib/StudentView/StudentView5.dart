...
class studentview5 extends StatefulWidget {
  const studentview5({super.key});

  @override
  State<studentview5> createState() => studentview5State();
}

class studentview5State extends State<studentview5> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user5');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user5');
