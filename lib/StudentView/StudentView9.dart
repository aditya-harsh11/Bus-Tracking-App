...
class studentview9 extends StatefulWidget {
  const studentview9({super.key});

  @override
  State<studentview9> createState() => studentview9State();
}

class studentview9State extends State<studentview9> {
  ...
  getLongitude() async {
    ...
    final docRef = db.collection('location').doc('user9');
  ...
  getLatitude() async {
    ...
    final docRef = ab.collection('location').doc('user9');
