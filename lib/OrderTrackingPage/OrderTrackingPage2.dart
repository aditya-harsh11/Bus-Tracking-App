...
class OrderTrackingPage2 extends StatefulWidget {
  ...
  const OrderTrackingPage2(this.user_id, {super.key});

  @override
  State<OrderTrackingPage2> createState() => OrderTrackingPage2State();
}

class OrderTrackingPage2State extends State<OrderTrackingPage2> {
