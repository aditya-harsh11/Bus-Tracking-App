...
import 'package:google_mao/OrderTrackingPage/OrderTrackingPage7.dart';
import 'package:location/location.dart' as loc;
import 'package:firebase_core/firebase_core.dart';
import 'package:permission_handler/permission_handler.dart';

class TeacherLocationSharing7 extends StatefulWidget {
  const TeacherLocationSharing7({super.key});

  @override
  TeacherLocationSharing7Overide createState() =>
      TeacherLocationSharing7Overide();
}
...
class TeacherLocationSharing7Overide extends State<TeacherLocationSharing7> {
  ...
  _getLocation() async {
    try {
      ...
      await FirebaseFirestore.instance.collection('location').doc('user7').set({
